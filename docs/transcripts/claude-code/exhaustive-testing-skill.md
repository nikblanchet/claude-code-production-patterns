...
description: Write comprehensive test coverage - tests are not optional and spending 60% of time on tests is acceptable
version: 1.0.0
---
...
**Pay attention to deprecation warnings in test output.**

When running tests, you may see deprecation warnings from libraries. Don't ignore them - address them immediately.

**See also:** `handle-deprecation-warnings` skill for detailed guidance on how to address deprecation warnings proactively.
